...
import DemandEditTabAccount from './DemandEditTabAccount.vue'
import DemandEditTabInformation from './DemandEditTabInformation.vue'
import DemandEditTabSocial from './DemandEditTabSocial.vue'
...
export default {
  components: {
    ...
    DemandEditTabAccount,
    DemandEditTabInformation,
    DemandEditTabSocial,
  },
  setup() {
